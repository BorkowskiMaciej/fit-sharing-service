...
public enum ErrorCode {
    ...
    NOT_AUTHENTICATED_USER_IN_HEADER(HttpStatus.FORBIDDEN, "SERVICE-0008", "Not authenticated user in the header."),
    BAD_CREDENTIALS(HttpStatus.UNAUTHORIZED, "SERVICE-0009", "Bad credentials."),
    INVALID_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "SERVICE-0010", "Expired token."),
